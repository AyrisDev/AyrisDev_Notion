const BLOG = {
  title: 'Ayris.Dev',
  author: 'Ayris.Dev',
  email: 'ayris.dev@gmail.com',
  link: 'https://ayris.dev',
  newsletter: 'Ayris.Dev',
  description: 'Ayris.Dev Portfolio Page',
  lang: 'en-US', // ['en-US', 'zh-CN', 'zh-HK', 'zh-TW', 'ja-JP', 'es-ES']
  timezone: 'Turkey', // See https://en.wikipedia.org/wiki/List_of_tz_database_time_zones for all options.
  ...
  socialLink: {
    twitter: 'https://twitter.com/mstfyldz_bjk1903',
    github: 'https://github.com/ayrisdev',
    telegram: 'https://t.me/Ayris_Dev'
  },
  seo: {
